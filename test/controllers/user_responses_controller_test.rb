...
class UserResponsesControllerTest < ActionController::TestCase
  ...
  test "should create user_response" do
    assert_difference('UserResponse.count') do
      post :create, user_response: { award: @user_response.award, question_instance_id: @user_response.question_instance_id, response: @user_response.response, user_id: @user_response.user_id }
    end
  ...
  test "should update user_response" do
    patch :update, id: @user_response, user_response: { award: @user_response.award, question_instance_id: @user_response.question_instance_id, response: @user_response.response, user_id: @user_response.user_id }
    assert_redirected_to user_response_path(assigns(:user_response))
  end
